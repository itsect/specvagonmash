		...
		L451.4,39.3L451.4,39.3z M451.4,49.3h4c2.4,0,3.7-0.9,3.7-2.6c0-1.5-1.2-2.3-3.7-2.3h-4V49.3z"/>
                    ...
                    <div className="-mr-2 -my-2 lg:hidden">
                        <Popover.Button
                            ...
                            <svg className="h-6 w-6" x-description="Heroicon name: outline/menu"
                    ...
                    <div className={'hidden lg:flex space-x-10 items-center'}>
                                                    ...
                                                    <div
                                                        ...
                                                        <div
                                                            ...
                                                            {categories.map((category) => (
                                                                <Menu.Item key={category.id}>
                                                                    {({active}) => (
                                                                        <a
                                                                            href={new URL('http://localhost:3000/products/' + category.slug)}
                                                        ...
                                                        <div
                                                            ...
                                                            <div className="flow-root">
                                                                <a href={new URL('http://localhost:3000/products')}
                                                            ...
                                                            <div className="flow-root">
                                                                <a href={new URL('http://localhost:3000/certificates')}
                                                                   className="-m-3 p-3 flex items-center rounded-md text-base font-medium text-gray-900 hover:bg-gray-100">
                                                                    <svg className="flex-shrink-0 h-6 w-6 text-blue-500"
                                                                        ...
                                                                        <g>
                                                                            <g fill="currentColor"
                                                                               transform="translate(0.000000,511.000000) scale(0.100000,-0.100000)">
                                                                                <path
                                                                                    d="M362.6,3846.9c-120.1-56.2-204.5-150.8-240.3-281.2c-20.4-61.3-25.6-1037.8-20.4-3024.1c7.7-2914.1,7.7-2932,61.3-3001c28.1-38.3,84.4-94.6,122.7-122.7c69-53.7,84.4-53.7,3111-61.3l3039.4-5.1v204.5v204.5H3471H505.7l5.1,2857.9l7.7,2855.4l4493.9,7.7l4491.4,5.1v-2863v-2863H9197h-306.7v-207.1v-204.5l380.9,7.7c416.7,7.7,455,20.4,575.2,184.1c53.7,69,53.7,79.2,53.7,3082.8c0,3003.6,0,3013.8-53.7,3082.9c-28.1,38.3-84.4,94.6-122.7,122.7l-69,53.7l-4593.6,5.1C633.5,3895.4,464.8,3892.9,362.6,3846.9z"/>
                                                                                <path
                                                                                    d="M1323.7,2668.4v-204.5h3681h3681v204.5v204.5h-3681h-3681V2668.4z"/>
                                                                                <path
                                                                                    d="M1323.7,1441.4v-204.5h3681h3681v204.5v204.5h-3681h-3681V1441.4z"/>
                                                                                <path
                                                                                ...
                                                                                <path
                                                                                    d="M1323.7,214.4V9.9H3471h2147.3v204.5v204.5H3471H1323.7V214.4z"/>
                                                                                <path
                                                                                    d="M1323.7-1012.6v-204.5H3471h2147.3v204.5v204.5H3471H1323.7V-1012.6z"/>
                                                                                <path
                                                                                    d="M6691.9-2853.1c0-449.9,7.7-818,15.3-818c7.7,0,219.9,166.2,470.4,370.7s467.8,370.7,483.1,370.7c12.8,0,217.3-155.9,455-347.6c235.2-191.7,444.8-360.4,462.7-375.8c23-17.9,30.7,143.1,30.7,797.5v820.6h-204.5h-204.5v-396.2v-396.2l-268.4,219.8c-189.2,153.4-278.6,212.2-301.6,194.3c-17.9-12.8-140.6-112.5-273.5-219.9l-242.9-196.8l-7.7,398.8l-7.7,396.2h-202h-204.5V-2853.1z"/>
                                                                            </g>
                                                                        </g>
                                                                    </svg>
                                                                    <span className="ml-3">Сертификаты</span>
                                                                </a>
                                                            </div>
                        ...
                        <a href={new URL('http://localhost:3000/about')}
                        ...
                        <a href={new URL('http://localhost:3000/contacts')}
            ...
            >
                {({open}) => {
                    useEffect(() => {
                        document.body.classList.add('overflow-hidden')
                        containerRef.current.classList.add('min-h-screen', 'overflow-y-scroll')
                        return () => {
                            document.body.classList.remove('overflow-hidden')
                            containerRef.current.classList.remove('min-h-screen', 'overflow-y-scroll')
                        }
                    }, [ open ])
                    return (
                        <Popover.Panel focus
		...
		h21.2v5.1h-13.5V39.3z M451.4,49.3h4c2.4,0,3.7-0.9,3.7-2.6c0-1.5-1.2-2.3-3.7-2.3h-4V49.3z"/>
                                        ...
                                        <div className="-mr-2">
                                            <Popover.Button
                                                ...
                                                <svg className="h-6 w-6" x-description="Heroicon name: outline/x"
                                                     xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                     stroke="currentColor" aria-hidden="true">
                                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"
                                ...
                                <div className="px-5 bg-gray-50 py-6 hidden">
                                    <nav className="grid gap-y-8">
                                        {categories.map((category) => (
                                            ...
                                            >
                                                <span
                                                    className="ml-3 text-base font-medium text-gray-900">{category.data.title}</span>
                                            </a>
                                        ))}
                                    </nav>
                                </div>
