                                                    ...
                                                    <div
                                                        ...
                                                        <div className="flow-root">
                                                            <a href={new URL('https://itsect.github.io/specvagonmash/certificates')}
                                                               className="-m-3 p-3 flex items-center rounded-md text-base font-medium text-gray-900 hover:bg-gray-100">
                                                                <svg className="flex-shrink-0 h-6 w-6 text-blue-500" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 1000 1000" enable-background="new 0 0 1000 1000" >
                                                                    <g>
